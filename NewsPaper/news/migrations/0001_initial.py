    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avthorUser', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Category',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avthor', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='news.avthor')),
            ],
        ),
        migrations.CreateModel(
            name='PostCategory',
